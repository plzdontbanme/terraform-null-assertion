...
# (for debugging) so Terraform doesn't wait for it and
# doesn't see any of the output.
$env_raw = Get-ChildItem env:* | Out-String
Start-Job -ArgumentList @("$PSScriptRoot", "$env_raw") -ScriptBlock {
param(
